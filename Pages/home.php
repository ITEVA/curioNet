        ...
        <div class="icons iconFinal">
            <a class="link" href="#contato">
                ...
                <div class="texto">
                    ...
                    <p class="info">Entre em contato conosco pra obter informações, tirar dúvidas, dar sugestões e
                        contratar nossos planos.</p>
                </div>
            </a>
        </div>
    </div>
            ...
            <div class="icons">
                <a class="link" href="#contrate">
                    ...
                    <div class="texto">
                        ...
                        <p class="info">Preencha o formulário para solicitar um orçamento ou entre em contato
                            conosco.</p>
                    </div>
                </a>
            </div>
